...
function show_character_select () {
    ...
    miniMenu.createMenuItem("ANDER"),
    miniMenu.createMenuItem("KIRA"),
    miniMenu.createMenuItem("RANDOM")
    )
    ...
    char_menu.onButtonPressed(controller.A, function (selection, selectedIndex) {
...
function show_name_input () {
    ...
    name_menu.onButtonPressed(controller.A, function (selection, selectedIndex) {
        names = [
        "HUNTER",
        "CYBER",
        "NEON",
