...
function show_main_menu() {
    ...
    main_menu = miniMenu.createMenu(miniMenu.createMenuItem("HISTORIA"), miniMenu.createMenuItem("CONFIGURACIÓN"), miniMenu.createMenuItem("VERSUS"), miniMenu.createMenuItem("THE END"))
    menu = main_menu
    estructura_menus()
